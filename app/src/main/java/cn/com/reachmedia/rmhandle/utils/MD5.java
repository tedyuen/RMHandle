...
public class MD5 {
	...
	public String getMD5ofStr(String s,String key) {
		return getMD5ofStr(s+key);
	}

    public String getMD5ofKeyStr(String s) {
        return getMD5ofStr(s+KEY);
    }
    ...
    public static String getMD5KeyStr(String s) {
        return getInstance().getMD5ofKeyStr(s);
    }
	...
	public static String getMD5Str(String string,String key) {
		return getInstance().getMD5ofStr(string,key);
	}
