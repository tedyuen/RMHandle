 ...
 */
public class ImageAllPagerActivity extends Activity implements ViewPager.OnPageChangeListener {
    ...
    public static List<ImageAllBean> imageData;
...
//        SelectImage = pagerPosition;
    ...
    private class ImagePagerAdapterLocalMerge extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup view, final int position) {
            ...
            ImageAllBean bean = imageData.get(position);
            if(bean!=null){
