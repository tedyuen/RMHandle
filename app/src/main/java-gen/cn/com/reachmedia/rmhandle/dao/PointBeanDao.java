...
public class PointBeanDao extends AbstractDao<PointBean, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property CheckState = new Property(17, Integer.class, "checkState", false, "CHECK_STATE");
        public final static Property IsPhoto = new Property(18, Integer.class, "isPhoto", false, "IS_PHOTO");
        public final static Property State = new Property(19, Integer.class, "state", false, "STATE");
        public final static Property StateType = new Property(20, Integer.class, "stateType", false, "STATE_TYPE");
        public final static Property UpdateTime = new Property(21, String.class, "updateTime", false, "UPDATE_TIME");
        public final static Property Pictime = new Property(22, String.class, "pictime", false, "PICTIME");
        public final static Property Worktime = new Property(23, String.class, "worktime", false, "WORKTIME");
        public final static Property Starttime = new Property(24, java.util.Date.class, "starttime", false, "STARTTIME");
        public final static Property Endtime = new Property(25, java.util.Date.class, "endtime", false, "ENDTIME");
        public final static Property Communityid = new Property(26, String.class, "communityid", false, "COMMUNITYID");
        public final static Property Communityname = new Property(27, String.class, "communityname", false, "COMMUNITYNAME");
        public final static Property FileId = new Property(28, String.class, "fileId", false, "FILE_ID");
        public final static Property FileUrlB = new Property(29, String.class, "fileUrlB", false, "FILE_URL_B");
        public final static Property FileUrlS = new Property(30, String.class, "fileUrlS", false, "FILE_URL_S");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'POINT_BEAN' (" + //
                ...
                "'CHECK_STATE' INTEGER," + // 17: checkState
                "'IS_PHOTO' INTEGER," + // 18: isPhoto
                "'STATE' INTEGER," + // 19: state
                "'STATE_TYPE' INTEGER," + // 20: stateType
                "'UPDATE_TIME' TEXT," + // 21: updateTime
                "'PICTIME' TEXT," + // 22: pictime
                "'WORKTIME' TEXT," + // 23: worktime
                "'STARTTIME' INTEGER," + // 24: starttime
                "'ENDTIME' INTEGER," + // 25: endtime
                "'COMMUNITYID' TEXT," + // 26: communityid
                "'COMMUNITYNAME' TEXT," + // 27: communityname
                "'FILE_ID' TEXT," + // 28: fileId
                "'FILE_URL_B' TEXT," + // 29: fileUrlB
                "'FILE_URL_S' TEXT);"); // 30: fileUrlS
        // Add Indexes
    ...
    protected void bindValues(SQLiteStatement stmt, PointBean entity) {
        ...
        if (checkState != null) {
            stmt.bindLong(18, checkState);
        }
 
        Integer isPhoto = entity.getIsPhoto();
        if (isPhoto != null) {
            stmt.bindLong(19, isPhoto);
        }
 
        Integer state = entity.getState();
        if (state != null) {
            stmt.bindLong(20, state);
        }
 
        Integer stateType = entity.getStateType();
        if (stateType != null) {
            stmt.bindLong(21, stateType);
        }
 
        String updateTime = entity.getUpdateTime();
        if (updateTime != null) {
            stmt.bindString(22, updateTime);
        }
 
        String pictime = entity.getPictime();
        if (pictime != null) {
            stmt.bindString(23, pictime);
        }
 
        String worktime = entity.getWorktime();
        if (worktime != null) {
            stmt.bindString(24, worktime);
        }
 
        java.util.Date starttime = entity.getStarttime();
        if (starttime != null) {
            stmt.bindLong(25, starttime.getTime());
        }
 
        java.util.Date endtime = entity.getEndtime();
        if (endtime != null) {
            stmt.bindLong(26, endtime.getTime());
        }
 
        String communityid = entity.getCommunityid();
        if (communityid != null) {
            stmt.bindString(27, communityid);
        }
        ...
        if (fileId != null) {
            stmt.bindString(29, fileId);
        }
 
        String fileUrlB = entity.getFileUrlB();
        if (fileUrlB != null) {
            stmt.bindString(30, fileUrlB);
        }
 
        String fileUrlS = entity.getFileUrlS();
        if (fileUrlS != null) {
            stmt.bindString(31, fileUrlS);
        }
    }
    ...
    public PointBean readEntity(Cursor cursor, int offset) {
        PointBean entity = new PointBean( //
            ...
            cursor.isNull(offset + 17) ? null : cursor.getInt(offset + 17), // checkState
            cursor.isNull(offset + 18) ? null : cursor.getInt(offset + 18), // isPhoto
            cursor.isNull(offset + 19) ? null : cursor.getInt(offset + 19), // state
            cursor.isNull(offset + 20) ? null : cursor.getInt(offset + 20), // stateType
            cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21), // updateTime
            cursor.isNull(offset + 22) ? null : cursor.getString(offset + 22), // pictime
            cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23), // worktime
            cursor.isNull(offset + 24) ? null : new java.util.Date(cursor.getLong(offset + 24)), // starttime
            cursor.isNull(offset + 25) ? null : new java.util.Date(cursor.getLong(offset + 25)), // endtime
            cursor.isNull(offset + 26) ? null : cursor.getString(offset + 26), // communityid
            cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27), // communityname
            cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28), // fileId
            cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29), // fileUrlB
            cursor.isNull(offset + 30) ? null : cursor.getString(offset + 30) // fileUrlS
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, PointBean entity, int offset) {
        ...
        entity.setCheckState(cursor.isNull(offset + 17) ? null : cursor.getInt(offset + 17));
        entity.setIsPhoto(cursor.isNull(offset + 18) ? null : cursor.getInt(offset + 18));
        entity.setState(cursor.isNull(offset + 19) ? null : cursor.getInt(offset + 19));
        entity.setStateType(cursor.isNull(offset + 20) ? null : cursor.getInt(offset + 20));
        entity.setUpdateTime(cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21));
        entity.setPictime(cursor.isNull(offset + 22) ? null : cursor.getString(offset + 22));
        entity.setWorktime(cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23));
        entity.setStarttime(cursor.isNull(offset + 24) ? null : new java.util.Date(cursor.getLong(offset + 24)));
        entity.setEndtime(cursor.isNull(offset + 25) ? null : new java.util.Date(cursor.getLong(offset + 25)));
        entity.setCommunityid(cursor.isNull(offset + 26) ? null : cursor.getString(offset + 26));
        entity.setCommunityname(cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27));
        entity.setFileId(cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28));
        entity.setFileUrlB(cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29));
        entity.setFileUrlS(cursor.isNull(offset + 30) ? null : cursor.getString(offset + 30));
     }
